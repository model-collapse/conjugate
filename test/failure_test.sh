#!/bin/bash
#
# Failure Testing for CONJUGATE Cluster
...
DATA_DIR="/tmp/conjugate-failure-test"
...
echo "=========================================="
echo " CONJUGATE Failure Testing Suite"
echo "=========================================="
echo ""
...
if [ $TESTS_FAILED -eq 0 ]; then
    ...
    echo "=========================================="
    echo ""
    echo "The CONJUGATE cluster demonstrates good resilience:"
