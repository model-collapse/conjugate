#!/bin/bash
#
# Start CONJUGATE Cluster for Testing/Benchmarking
#
...
DATA_DIR="${DATA_DIR:-/tmp/conjugate-test}"
LOG_DIR="$DATA_DIR/logs"

echo "=========================================="
echo " Starting CONJUGATE Cluster"
echo "=========================================="
echo ""

# Check if cluster is already running
if pgrep -f "conjugate-master" > /dev/null; then
