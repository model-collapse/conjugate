...
func TestRESTAPIClusterHealth(t *testing.T) {
	...
	if health.ClusterName != "conjugate-cluster" {
		t.Errorf("Expected cluster name 'conjugate-cluster', got %s", health.ClusterName)
	}
}
...
func TestRESTAPIRootEndpoint(t *testing.T) {
	...
	AssertJSONField(t, data, "name", "CONJUGATE")
	AssertJSONField(t, data, "cluster_name", "conjugate-cluster")
...
func TestRESTAPIClusterState(t *testing.T) {
	...
	AssertJSONField(t, state, "cluster_name", "conjugate-cluster")
...
func TestRESTAPINodes(t *testing.T) {
	...
	AssertJSONField(t, nodes, "cluster_name", "conjugate-cluster")
