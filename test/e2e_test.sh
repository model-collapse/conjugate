#!/bin/bash
#
# End-to-End Integration Test for CONJUGATE Phase 1
...
echo "=========================================="
echo " CONJUGATE Phase 1 - E2E Integration Test"
echo "=========================================="
echo ""
...
DATA_DIR="/tmp/conjugate-e2e-test"
...
if echo "$GET_RESPONSE" | grep -q "CONJUGATE Search Engine"; then
