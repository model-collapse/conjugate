...
var (
	cacheHits = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "conjugate_query_cache_hits_total",
	...
	cacheMisses = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "conjugate_query_cache_misses_total",
	...
	cacheEvictions = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "conjugate_query_cache_evictions_total",
	...
	cacheSize = promauto.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "conjugate_query_cache_size",
	...
	cacheSizeBytes = promauto.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "conjugate_query_cache_size_bytes",
	...
	cacheHitRate = promauto.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "conjugate_query_cache_hit_rate",
