...
func LoadMasterConfig(cfgFile string) (*MasterConfig, error) {
	...
	v.SetDefault("data_dir", "/var/lib/conjugate/master")
	...
	if cfgFile != "" {
		...
		v.AddConfigPath("/etc/conjugate/")
		v.AddConfigPath("$HOME/.conjugate/")
		v.AddConfigPath(".")
	}

	// Read environment variables
	v.SetEnvPrefix("CONJUGATE")
	v.AutomaticEnv()
...
func LoadDataNodeConfig(cfgFile string) (*DataNodeConfig, error) {
	...
	v.SetDefault("data_dir", "/var/lib/conjugate/data")
	v.SetDefault("master_addr", "localhost:9301")
